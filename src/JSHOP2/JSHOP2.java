...
class InternalVars
{
  ...
  */
  ...
  /** The information for the backtracking process why it has happened 
   */
  BacktrackReason bt;
  ...
  private boolean findPlanHelper(TaskList chosenTask)
  {
    ...
    while (v.e.hasNext())
    {
      ...
      if (v.t.isPrimitive())
      {
        ...
        if(v.bt == JSHOP2Output.BacktrackReason.NOBACKTRACKING && v.o.length==0)
        	v.bt = JSHOP2Output.BacktrackReason.NOOPERATOR;
      ...
      else
      {
        ...
        if(v.bt == JSHOP2Output.BacktrackReason.NOBACKTRACKING && v.m.length==0)
        	v.bt = JSHOP2Output.BacktrackReason.NOMETHOD;
